...
public class FormPage {
	...
	public boolean isDataSaved() {
		try {
			wait.until(ExpectedConditions.attributeToBe(By.xpath("//*[contains(@class, 'poruka')]"), "style", "visibility: visible"));
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	public void fillInTheForm(String name, String radioValue, String dob, String email, String role, 
									String value, String comment) {
		this.getNameInput().sendKeys(name);
		this.getRadio(radioValue);
		this.getDobInput().sendKeys(dob);
